<template>
  ...
  >
    ...
    <div class="menu-item px-3">
      <div class="menu-content d-flex align-items-center px-3">
        ...
        <div class="symbol symbol-50px me-5">
          <avatar shape="circle" first-name="Emma" last-name="Smith" />
        </div>
        <!--end::Avatar-->
        ...
        <div class="d-flex flex-column">
          ...
          <router-link to="#" class="fw-bold text-muted text-hover-primary fs-7"
            >max@kt.com</router-link
          >
        </div>
        <!--end::Username-->
      </div>
    ...
    <div class="menu-item px-5">
      <router-link to="/pages/profile/overview" class="menu-link px-5">
        <span class="menu-text">My Platforms</span>
        ...
        <div class="menu-item px-3">
          ...
          >
            <span class="symbol symbol-20px me-4">
              <img
                class="rounded-1"
                src="/svg/flags/united-states.svg"
                alt="metronic"
              />
            </span>
            English
